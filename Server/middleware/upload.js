...
const folders = { candidatePhoto: path.join(uploadsRoot, "candidates"), aadhaarCard: path.join(uploadsRoot, "documents"), dobCertificate: path.join(uploadsRoot, "documents") };
